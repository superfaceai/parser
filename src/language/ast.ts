 ...
 * @internal
 */
export function isNode(maybeNode?: ASTNode): maybeNode is ASTNode {
...
export type StatementNode = {
  readonly kind: 'StatementNode';
  readonly loc?: Location;
  readonly identifiers: NameNode[];
  readonly value?: ValueNode | DictionaryNode;
};

export type DictionaryNode = {
  readonly kind: 'DictionaryNode';
  readonly loc?: Location;
