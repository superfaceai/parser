...
export function tryParseNumberLiteral(slice: string): ParseResult<LiteralTokenData> {
  ...
  const digitsStringSlice = slice.slice(prefixLength, prefixLength + numberLength);
